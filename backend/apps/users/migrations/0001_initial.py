# Generated by Django 6.0.5 on 2026-05-08 06:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('employer', 'Employer'), ('job_seeker', 'Job Seeker')], default='', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_type', models.CharField(choices=[('restaurant', 'Restaurant'), ('events', 'Events'), ('health_care', 'Health Care'), ('other', 'Other')], max_length=50)),
